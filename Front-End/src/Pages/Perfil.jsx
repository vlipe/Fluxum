  ...
  <div>
    ...
    <input
      ...
      className={`
        ...
        bg-slate-100    
        text-roxo text-[13px]       
        placeholder-roxo/50 placeholder:text-[13px]   
        rounded-xl                
        border-none                 
        focus:outline-none          
        focus:ring-2               
...
const Dashboard = () => {
  return (
    <div className="min-h-screen w-full bg-deletar flex flex-col items-center justify-center p-4 sm:p-6">
